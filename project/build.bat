...
set CommonLinkerFlags=-opt:ref /LIBPATH:"C:\Users\a\Desktop\git\SDLstuff" include\SDL2.lib include\SDL2main.lib include\SDL2_image.lib include\SDL2_ttf.lib /SUBSYSTEM:CONSOLE
